 ...
 public:
  ...
  virtual bool Generate(const grpc::protobuf::FileDescriptor* file,
    ...
    grpc::string mock_code =
        grpc_c_generator::GetMockPrologue(&pbfile, generator_parameters) +
        grpc_c_generator::GetMockIncludes(&pbfile, generator_parameters) +
        grpc_c_generator::GetMockServices(&pbfile, generator_parameters) +
        grpc_c_generator::GetMockEpilogue(&pbfile, generator_parameters);
